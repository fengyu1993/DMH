...
T_d_DMH = ForwardKinematic(S, Gamma, q_DMH, q_bar);
% error
error = norm(Log6(TransInv(T_d_DMH) * T_d));
fprintf("error: %d\n", error);
%% Plot
figure;
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [S, Gamma] = get_KUKA_POE_Nominal()
    r1 = 395; r2 = 420; r3 = 400; L = 1341;
    w1 = [0; 0; 1];     P1 = [0; 0; r1];
    w2 = [0; -1; 0];    P2 = [0; 0; r1];
    w3 = [0; 0; 1];     P3 = [0; 0; r1];
    w4 = [0; 1; 0];     P4 = [0; 0; r1 + r2];
    w5 = [0; 0; 1];     P5 = [0; 0; r1 + r2];
    w6 = [0; -1; 0];    P6 = [0; 0; r1 + r2 + r3];    
    w7 = [0; 0; 1];     P7 = [0; 0; r1 + r2 + r3];     
    S1_init = [w1; -cross(w1, P1)];
    S2_init = [w2; -cross(w2, P2)];
    S3_init = [w3; -cross(w3, P3)];
    S4_init = [w4; -cross(w4, P4)];
    S5_init = [w5; -cross(w5, P5)];
    S6_init = [w6; -cross(w6, P6)];
    S7_init = [w7; -cross(w7, P7)];
    Gamma = [0; 0; 0; 0; 0; L];
    S = [S1_init; S2_init; S3_init; S4_init; S5_init; S6_init; S7_init];
end
